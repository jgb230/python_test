...
class AccessToken:
    ...
    def create_token(access_key_id, access_key_secret):
        parameters = {'AccessKeyId': access_key_id,
                      ...
                      'Version': '2019-02-28'}
        # 构造规范化的请求字符串
        print('key: %s' % access_key_id)
        print('secret: %s' % access_key_secret)
        ...
        secreted_string = hmac.new(bytes(access_key_secret + '&', encoding='utf-8'),
                                   ...
                                   hashlib.sha1).digest()
        print('hmac签名: %s' % secreted_string)
...
if __name__ == "__main__":
    # 用户信息
    access_key_id = 'LTAI4GA41t3utz4DcLm9VnPr'
    access_key_secret = 'sZ6vQvb8lk4ZHdQke6H2Bz0WtQwK3p'
